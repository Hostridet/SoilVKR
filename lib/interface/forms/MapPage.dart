      ...
      child: Scaffold(
          ...
          body: RepositoryProvider(
            ...
            child: BlocProvider<MapBloc>(
              ...
              child: BlocConsumer<MapBloc, MapState>(listener: (context, state) {
                ...
                return FlutterLocationPicker(
                    ...
                    onPicked: (pickedData) {
                      BlocProvider.of<MapBloc>(context).add(MapGetEvent(pickedData.latLong.latitude, pickedData.latLong.longitude));
                    });
              }),
            ),
          )),
