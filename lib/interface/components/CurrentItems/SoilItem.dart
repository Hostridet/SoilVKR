      ...
      child: Scaffold(
        ...
        body: RepositoryProvider(
          ...
          child: BlocProvider<PointBloc>(
            create: (context) => PointBloc(RepositoryProvider.of<PointRepository>(context))..add(PointGetSoilEvent(widget.args.point.id)),
                                ...
                                child: ListTile(
                                  ...
                                  leading: SizedBox(
                                      ...
                                      child: state.soilList[index].image == null
                                          ...
                                          : Image.memory(
                                              base64Decode(state.soilList[index].image!),
                                              fit: BoxFit.fill,
                                            )),
                                  subtitle: Text(
                                    state.soilList[index].name,
                                  ...
                                  onTap: () {
                                    Navigator.of(context).pushReplacementNamed('/home/book/soil',
                                        arguments:
                                            ItemWithRoute(id: state.soilList[index].id, route: '/home/points/soil', point: widget.args));
                                  },
                                ),
                              );
                            }),
