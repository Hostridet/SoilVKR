    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        body: RepositoryProvider(
          ...
          child: BlocProvider(
            create: (context) => MapBloc(RepositoryProvider.of<MapRepository>(context))..add(MapIsAdmin()),
                ...
                return FlutterLocationPicker(
                    ...
                    onPicked: (pickedData) async {
                      BlocProvider.of<MapBloc>(context).add(
                          MapUpdateEvent(widget.point.id, pickedData.address, pickedData.latLong.latitude, pickedData.latLong.longitude));
