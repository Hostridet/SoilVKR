      ...
      child: Scaffold(
        ...
        body: RepositoryProvider(
          ...
          child: BlocProvider<PointBloc>(
            create: (context) => PointBloc(RepositoryProvider.of<PointRepository>(context))..add(PointGetOneEvent(widget.args.point.id)),
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                          ...
                          ListTile(
                            title: state.point.address != null ? Text(state.point.address!) : Text("Неизвестно"),
                            subtitle: Text("Адрес"),
                          ),
                          Divider(
                            thickness: 1.0,
                          ...
                          Card(
                            ...
                            child: ListTile(
                              ...
                              onTap: () {
                                Navigator.of(context).pushReplacementNamed('/home/points/soil',
                          ...
                          Card(
                            ...
                            child: ListTile(
                              ...
                              onTap: () {
                                Navigator.of(context).pushReplacementNamed('/home/points/animal',
                                    arguments: PointWithRoute(point: state.point, route: widget.args.route));
                              },
                            ),
                          ),
                          Card(
                            ...
                            child: ListTile(
                              ...
                              onTap: () {
                                Navigator.of(context).pushReplacementNamed('/home/points/plant',
                                    arguments: PointWithRoute(point: state.point, route: widget.args.route));
                              },
                            ),
                          ),
                          Card(
                            ...
                            child: ListTile(
                              ...
                              onTap: () {
                                Navigator.of(context).pushReplacementNamed('/home/points/ground',
                                    arguments: PointWithRoute(point: state.point, route: widget.args.route));
                              },
                            ),
                          ),
