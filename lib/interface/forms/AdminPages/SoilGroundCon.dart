      ...
      child: Scaffold(
        ...
        body: RepositoryProvider(
          ...
          child: BlocProvider<SoilBloc>(
            create: (context) => SoilBloc(RepositoryProvider.of<SoilRepository>(context))..add(SoilGetGroundConEvent()),
                                    ...
                                    children: [
                                      SlidableAction(
                                        onPressed: (_) async {
                                          ...
                                          BlocProvider.of<SoilBloc>(context).add(SoilGetGroundConEvent());
                                        },
        ...
        floatingActionButton: FloatingActionButton(
          ...
          onPressed: () {
            Navigator.of(context).pushReplacementNamed('/home/admin/soilground/add');
          },
